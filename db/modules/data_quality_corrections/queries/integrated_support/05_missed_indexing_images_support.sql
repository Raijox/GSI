/* ============================================================================
   File: 05_missed_indexing_images_support.sql
   Module: Data Quality Corrections
   Role in assembly:
   - Local copy of the missed-indexing image review schema used by the
     integrated data quality corrections tool.
   Why this file exists:
   - The integrated DQ scan can surface image review counts inline, so the
     supporting review and audit tables should bootstrap from within this module.
   What lives here:
   - corrections_missed_indexing_images creation.
   - supporting unique/status indexes and audit storage.
   Maintenance notes:
   - Preserve the queue semantics expected by the standalone missed-indexing
     image workflow.
   ============================================================================ */
