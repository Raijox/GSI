/* ============================================================================
   File: 01_instrument_type_history_support.sql
   Module: Data Quality Corrections
   Role in assembly:
   - Local copy of the instrument-type correction history schema used by the
     integrated data quality corrections tool.
   Why this file exists:
   - The integrated DQ tool can auto-apply saved instrument-type history and can
     surface the same correction workflow inline, so it should own the schema it
     depends on instead of reaching into another module at runtime.
   What lives here:
   - corrections_instrument_types table creation/backfills.
   - supporting indexes and audit table creation.
   Maintenance notes:
   - Keep this file behaviorally aligned with the standalone instrument-type
     correction tool unless the integrated DQ flow intentionally diverges.
   ============================================================================ */
