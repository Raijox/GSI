/* ============================================================================
   File: 03_legal_type_others_support.sql
   Module: Data Quality Corrections
   Role in assembly:
   - Local copy of the legal-type-other correction storage used by the
     integrated data quality corrections tool.
   Why this file exists:
   - The integrated DQ legal workflow can route users into the same persisted
     fix tables, so those tables should bootstrap from within this module.
   What lives here:
   - corrections_other_type_legals creation/backfills.
   - supporting gdi legal-row bridge columns and audit storage.
   Maintenance notes:
   - Keep the main-table and audit-table contracts synchronized with the
     standalone legal-type-other tool.
   ============================================================================ */
/* ============================================================================
